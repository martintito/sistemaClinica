...
public class Utils {
     public static String cantidadConLetra(BigDecimal s) {
       StringBuilder result = new StringBuilder();
       // BigDecimal totalBigDecimal = new BigDecimal(s).setScale(2, BigDecimal.ROUND_DOWN);
       BigDecimal totalBigDecimal=s;
        ...
        String cortar=String.valueOf(totalBigDecimal);
      String decimal_[]=  cortar.split("\\.");
        //System.out.println("yury: "+cortar);      
        result.append(" y "+decimal_[1]+"/100");
