...
public class ManagedBeanGastoEconomico implements Serializable {
    ...
    public void selecciona_objeto(GastosEconomicos obj_){
    gastoseconomicos=obj_;
    }
    ...
    public void crearGasto(Date fecha_) {

        try {
            // se corrige aqui.
            gastoseconomicos.setFechaCreacion(fecha_);
            gastosEconomicosFacade.create(gastoseconomicos);
    ...
    public void editar_gasto(Date fecha_) {

        try {
          
            gastosEconomicosFacade.edit(gastoseconomicos);
