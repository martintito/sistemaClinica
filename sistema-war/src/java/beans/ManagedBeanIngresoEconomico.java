...
public void selecciona_objeto(IngresosEconomicos obj_){
ingresoseconomicos=obj_;
}
...
public void crearIngreso(Date fecha_){

    try {
       ingresoseconomicos.setFechaCreacion(fecha_);
       ingresosEconomicosFacade.create(ingresoseconomicos);
       this.buscarFecha(fecha_);
         FacesMessage msg = new FacesMessage("CREADO CON EXITO", "CORRECTO");
        FacesContext.getCurrentInstance().addMessage(null, msg);
    } catch (Exception e) {
        e.printStackTrace();
...
public void editarIngreso(Date fecha_){

    try {
       
       ingresosEconomicosFacade.edit(ingresoseconomicos);
       this.buscarFecha(fecha_);
