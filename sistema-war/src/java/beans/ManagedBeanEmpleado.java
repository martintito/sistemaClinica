...
public class ManagedBeanEmpleado implements Serializable {
    ...
    public int getCambio_clave() {
        return cambio_clave;
    }

    public void setCambio_clave(int cambio_clave) {
    ...
    public void editarNew() {
        ...
        try {
            if(cambio_clave==1){
            empleado.setPassword(nueva_clave);
            }
            empleado.setActualizaClave(cambio_clave);
            empleadoFacade.edit(empleado);
            cambio_clave=0;
            nueva_clave="";
